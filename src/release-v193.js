...
function syncReleaseLabels() {
  ...
  if (footer) footer.textContent = `A.I VĂN PHÒNG · ${RELEASE} · AI CORE ${AI_CORE} · CANCEL ${GLOBAL_CANCEL} · SOURCE ROUTER ${KNOWLEDGE_ROUTER} · INTERNAL ${INTERNAL_SOURCE_CONTROL} · MULTISOURCE ${MULTISOURCE_ORCHESTRATOR} · SAFETY ${RESEARCH_SAFETY} · INTERACTION ${INTERACTION_CONTROL} · VOICE ${VOICE_RENDER_BRIDGE} · TURN ${VOICE_TURN_COORDINATOR} · RUNTIME ${CREDENTIALS_RUNTIME} · PRODUCT ${PRODUCT_COMPLETION} · Dashboard v1.5 approved`;
